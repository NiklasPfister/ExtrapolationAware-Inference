...
import torch
import numpy as np
from experiments.helpers.conformal.cqr import torch_models
from functools import partial
from experiments.helpers.conformal.cqr import tune_params_cv
from experiments.helpers.conformal.nonconformist.cp import IcpRegressor
from experiments.helpers.conformal.nonconformist.base import RegressorAdapter
...
class QuantileForestRegressorAdapter(RegressorAdapter):
    ...
    def __init__(self,
        ...
        self.params = params
        self.rfqr = RandomForestQuantileRegressor(**params["rf_pars"])
